...
\begin{enumerate}
%6.1     SAURANE
    \item Fonctionnalités réalisées qui étaient présentent dans le cahier des charges 
    \begin{itemize}
        \item interface graphique avec une fenêtre d'affichage du fluide et des curseurs
    ...
    \end{itemize}
%6.2
    \item Fonctionnalités non réalisées qui étaient présentent dans le cahier des charges
    \begin{itemize}
        \item possibilité de contrôler le fluide à distance via un smartphone (bluetooth)
