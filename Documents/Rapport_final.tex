...
\item Saurane : Motiver l'intérêt du problème étudié par rapport à votre parcours d'études et au monde de l'informatique.
    \begin{itemize}
        \item projet transverse à l'info et aux physique/maths étant donné notre double licence
        Ce projet de simulation de fluides en 2D nous a parru être le plus adapté étant donné notre parcours actuel en double licence 
        en mathématiques et informatique. Nos connaissances en mathématiques nous ont permis de comprendre les concepts de base de la simulation, 
        ce qui a motivé notre interet pour ce projet.
...
\item Saurane : Présenter les différentes approches possibles pour la résolution du problème, et en particulier celle choisie.
    \begin{itemize}
