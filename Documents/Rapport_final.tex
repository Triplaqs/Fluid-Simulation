...
\end{abstract}
=======
>>>>>>> 4ccff5a (modif selon conseils de Marc)
\newpage
...
\gaelle {
    Nous avons mis en place un affichage sous forme de grille de chaleur \add{(Figure~\ref{figure1})}. Pour mettre 
...
\begin{figure}[H]
    ...
    \caption{Affichage d'une grille de chaleur. Le rouge représente les points les plus chauds et le bleu les plus froids.} \comment{}{Si vous avez 2 images avant/après, ça permet de voir une évolution. Une seule, c'est pas vraiment une évolution}
    \label{figure1_1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Affichage d'une grille de chaleur évolution 2 au cours du temps.} \comment{}{Si vous avez 2 images avant/après, ça permet de voir une évolution. Une seule, c'est pas vraiment une évolution}
    \label{figure1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Affichage d'une grille de chaleur, évolution 3 au cours du temps} \comment{}{Si vous avez 2 images avant/après, ça permet de voir une évolution. Une seule, c'est pas vraiment une évolution}
    \label{figure1_3}
\end{figure}
