...
\addto\captionsfrench{
  ...
  \newcommand{\abstractnames}{Abstarct}
}
\usepackage{fullpage}
\usepackage{xcolor}
...
\item Présenter les principaux modules du logiciel développé dans le cadre du projet. Utiliser le langage UML pour la modélisation : donner le diagramme de cas d'utilisation et le diagramme des classes.
    ...
    \end{itemize}
     \begin{figure}[H]
        \centering
        \includegraphics[width=0.45\textwidth]{PJ_proj/diag_uml.png}
    ...
    \item Point ou ligne : {\color{olive}Nous avons ajouté dans l’interface un paramètre permettant
...
\item Évaluer la complexité théorique en temps des algorithmes présentés
    \begin{itemize}
        ...
        \item {\color{WildStrawberry}La Diffusion : \\
        L’algorithme parcourt une grille de taille $N \times N$ à chaque itération, ce qui représente un coût de $N^2$. 
