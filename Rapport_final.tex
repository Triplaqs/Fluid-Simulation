...
\begin{itemize}
    \item fentre ? (ça se repete avec la partie 4)
    \item zone de rendu ?
    \item panneau de parametres
\end{itemize}
...
\begin{itemize}
\item choisir 2 parmis : advection ou diffusion ou projection
\end{itemize}
\item 	Évaluer la complexité théorique en temps des algorithmes présentés
\begin{itemize}
\item complexité algo 1
\item complexité algo 2
\end{itemize}
\end{enumerate}
...
\begin{itemize}
\item DEMANDER A MARC (densité ? quand on change trop vite les paramètres)
\end{itemize}
...
\begin{itemize}
\item passage de la grille de part à la nouvelle grille (grosse partie)
\item (truc de satine si la partie d'avant est trop courte)
\end{itemize}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item fonctionnalités non rélisées qui étaient présentent dans le cahier des charges ou que l'on aurait pu implémenter avec plus de temps
    \begin{itemize}
        ...
        \item implémentation la méthode lagrangienne (à voir si Axel termine)
    \end{itemize}
\end{enumerate}
