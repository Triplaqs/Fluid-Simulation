...
\begin{document}
   ...
   \ganttbar[
      bar/.append style={fill=bleu}
   ]{Diffusion et viscosité}{2}{4} \\

   \ganttbar[
      bar/.append style={fill=red!60!black}
   ...
   \ganttbar[
      bar/.append style={fill=blue!60!black}
   ]{Visualisation}{7}{9} \\
   ...
   \ganttbar[
      bar/.append style={fill=blue, red, green, orange}
   ...
   \ganttbar[
      bar/.append style={fill=green!60!black}
   ...
   \begin{itemize}
      \item \textcolor{gray!70}{Tâches déjà réalisées}
      \item \textcolor{blue}{Axel}
      \item \textcolor{red}{Saurane}
      \item \textcolor{green!60!black}{Gaëlle}
